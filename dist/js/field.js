...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	computed: {
		resourceLabels: function resourceLabels() {
			var _this = this;

			var values = [];
			this.resources.forEach(function (r) {
				return values.push(r[_this.field.label]);
			});
			return values;
		}
	},
	methods: {
		getAvailableResources: function getAvailableResources() {
			...
			return Nova.request().get('/nova-vendor/searchable-select/' + this.field.searchableResource, {
				params: {
...
var render = function() {
  ...
  return _c("span", [
    _vm.field.isMultiple
      ? _c("span", [
          _vm.resourceLabels.length > 0
            ? _c("span", [_vm._v(_vm._s(_vm.resourceLabels.join(", ")))])
            : _c("span", [_vm._v("—")])
        ])
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	computed: {
		...
		fieldValue: function fieldValue() {
			if (this.field.value === '' || this.field.value === null || this.field.value === undefined || this.field.value === '[]') {
				return false;
			}
          ...
          _c("template", { slot: "value" }, [
            _vm.fieldValue
              ? _c("div", { staticClass: "text-90" }, [
                  _vm.field.isMultiple
                    ? _c("div", [_vm._v(_vm._s(_vm.resourceLabels.join(", ")))])
                    : _c("div", [_vm._v(_vm._s(_vm.fieldValue))])
                ])
              : _c("div", [_vm._v("—")])
          ])
        ],
...
/* harmony default export */ __webpack_exports__["default"] = ({
	mixins: [__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["PerformsSearches"], __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["HandlesValidationErrors"]],
  ...
  */
	...
	methods: {
		existingResourceIndex: function existingResourceIndex(value) {
			var _this = this;

			var index = -1;
			this.selectedResources.forEach(function (r, i) {
				if (r[_this.field.valueField] == value[_this.field.valueField]) {
					index = i;
				}
			});
		...
		removeResource: function removeResource(value) {
			this.selectedResources.splice(this.existingResourceIndex(value), 1);
		},
		selectResource: function selectResource(value) {
			if (this.field.isMultiple) {
		...
		initializeComponent: function initializeComponent() {
			...
			if (this.shouldSelectInitialResource) {
				this.getAvailableResources().then(function () {
					return _this2.selectInitialResource();
				});
			}
		...
		fill: function fill(formData) {
			...
			if (this.field.isMultiple) {
				...
				this.selectedResources.forEach(function (r) {
					ids.push(r[_this3.field.valueField]);
				});
   ...
   */
		getAvailableResources: function getAvailableResources() {
			...
			params.params.resource_ids = JSON.stringify(this.selectedResourcesIds);
			params.params.ignore_resource_ids = true;
			return Nova.request().get('/nova-vendor/searchable-select/' + this.field.searchableResource, params).then(function (response) {
				// Turn off initializing the existing resource after the first time
				_this4.initializingWithExistingResource = false;
				_this4.availableResources = response.data.resources;
   ...
   */
		determineIfSoftDeletes: function determineIfSoftDeletes() {
			...
			return storage.determineIfSoftDeletes(this.field.resourceName).then(function (response) {
				_this5.softDeletes = response.data.softDeletes;
			});
		},
   ...
   */
		selectInitialResource: function selectInitialResource() {
			...
			if (this.field.isMultiple) {
				this.availableResources.forEach(function (r) {
					if (_this6.field.value.includes(r[_this6.field.valueField])) {
						_this6.selectedResources.push(r);
					}
				});
			} else {
				this.selectedResource = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.find(this.availableResources, function (r) {
					return r[_this6.field.valueField] == _this6.selectedResourceId;
				});
			}
		}
	},
	...
	computed: {
		selectedResourcesIds: function selectedResourcesIds() {
			var _this7 = this;

			var ids = [];
			this.selectedResources.forEach(function (r) {
				ids.push(r[_this7.field.valueField]);
			});
  ...
  return _c(
    ...
    [
      _c(
        ...
        { slot: "field" },
        [
          _vm.selectedResources.length
            ? _c(
                "div",
                { staticClass: "mb-3 searchable-select__selected-resources" },
                _vm._l(_vm.selectedResources, function(resource, index) {
                  return _c(
                    "div",
                    {
                      key: index,
                      staticClass:
                        "shadow-md mr-3 inline-block rounded-lg bg-gray-400 mb-3",
                      attrs: { data: resource }
                    },
                    [
                      _c(
                        ...
                        [
                          _c("div", { staticClass: "mr-2" }, [
                            _vm._v(_vm._s(resource[_vm.field.label]))
                          ]),
                          _vm._v(" "),
                          _c(
                            "div",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.removeResource(resource)
                                }
                              }
                            },
                            [
                ...
                [
                  _vm.searching
                    ? _c(
                        ...
                        {
                          staticClass:
                            "bg-none py-3 overflow-hidden absolute rounded-lg shadow-lg w-full mt-0 max-h-search overflow-y-auto",
                          staticStyle: { left: "0" }
                        },
                        [
                          _c("loader", {
